...
try {
    ...
    $responseGetCloudServiceProperties = $client->get('services/hostedservices/i2b2dev' . $custidtrimmed);
    ...
    echo 'In around 20 minutes, i2b2 will be available here <a href="' . $azureurl . 'i2b2/webclient" target="_blank">' . $azureurl . 'i2b2/webclient</a><br><br>';

	$message = "A new i2b2 instance has been generated by *". $user->email . "* at <http://" . $azureurl . "/i2b2UploaderWebapp|" . $azureurl . ">";
