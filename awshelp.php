...
<html>
	...
	<body>
		<div id="protected-page">
			...
			<p>Go to the <a href="https://console.aws.amazon.com/iam/home?#users">IAM console</a></p>
			<p>Click <code>Create New Users</code>.</p>
			<p><a href="#" data-featherlight="assets/img/aws_1.png"><img src="assets/img/aws_1_thumb.png" alt="" /></a></p>
			<p>Enter a username and ensure <code>Generate an access key for each user</code> is checked. Click <code>Create</code>.</p>
			<p><a href="#" data-featherlight="assets/img/aws_2.png"><img src="assets/img/aws_2_thumb.png" alt="" /></a></p>
			...
			<p><a href="#" data-featherlight="assets/img/aws_3.png"><img src="assets/img/aws_3_thumb.png" alt="" /></a></p>
			<p>Click on the newly created user account and click <code>Attach User Policy</code>.</p>
			<p><a href="#" data-featherlight="assets/img/aws_4.png"><img src="assets/img/aws_4_thumb.png" alt="" /></a></p>
			...
			<p><a href="#" data-featherlight="assets/img/aws_5.png"><img src="assets/img/aws_5_thumb.png" alt="" /></a></p>
			...
			<p><a href="#" data-featherlight="assets/img/aws_6.png"><img src="assets/img/aws_6_thumb.png" alt="" /></a></p>
		</div>
